...
import 'package:story_app/data/common/exception/custom_exception.dart';
import 'package:story_app/data/model/request/create_story_request_model.dart';
import 'package:story_app/data/model/request/login_request_model.dart';
import 'package:story_app/data/model/request/register_request_model.dart';
import 'package:story_app/data/model/request/story_request_model.dart';
import 'package:story_app/data/model/response/create_story_response_model.dart';
import 'package:story_app/data/model/response/detail_story_response_model.dart';
import 'package:story_app/data/model/response/login_response_model.dart';
import 'package:story_app/data/model/response/register_response_model.dart';
import 'package:http/http.dart' as https;
import 'package:story_app/data/model/response/story_response_model.dart';
...
class ApiService {
  ...
  Future<CreateStoryResponseModel> uploadImage(
    String token,
    CreateStoryRequestModel storyData,
  ) async {
    ...
    if (statusCode == 201) {
      return CreateStoryResponseModel.fromJson(json.decode(responseData));
    } else {
