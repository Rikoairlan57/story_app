...
import 'package:story_app/ui/screen/camera_screen.dart';
          ...
          child: Form(
            ...
            child: Column(
              children: [
                Expanded(
                  flex: 3,
                  child: context.watch<CreateStoryProvider>().imagePath == null
                      ? const Align(
                ...
                Container(
                  ...
                  child: context.watch<CreateStoryProvider>().isUploading
